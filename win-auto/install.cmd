...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Invoke-WebRequest '%ODT_SETUP_URL%' -OutFile '%ODT_DIR%\Setup.exe'; Invoke-WebRequest '%ODT_XML_URL%' -OutFile '%ODT_DIR%\configuration.xml'"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command "& ([ScriptBlock]::Create((New-Object Net.WebClient).DownloadString('https://get.activated.win'))) /HWID /Ohook"
if errorlevel 1 (
